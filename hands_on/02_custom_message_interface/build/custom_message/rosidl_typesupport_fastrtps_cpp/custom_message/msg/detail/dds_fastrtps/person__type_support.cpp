...
#include "custom_message/msg/detail/person__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_message::msg::Person & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_message::msg::Person & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_message::msg::Person;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_message::msg::Person *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_message::msg::Person *>(
    untyped_ros_message);
...
{
  return &custom_message::msg::typesupport_fastrtps_cpp::_Person__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_message, msg, Person)() {
  return &custom_message::msg::typesupport_fastrtps_cpp::_Person__handle;
}
