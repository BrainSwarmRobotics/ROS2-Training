...
#include "custom_message/msg/detail/person__rosidl_typesupport_fastrtps_c.h"
...
using _Person__ros_msg_type = custom_message__msg__Person;
...
size_t get_serialized_size_custom_message__msg__Person(
  const void * untyped_ros_message,
...
static uint32_t _Person__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_message__msg__Person(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_message
size_t max_serialized_size_custom_message__msg__Person(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_message__msg__Person;
    is_plain =
      (
...
static size_t _Person__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_message__msg__Person(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_message, msg, Person)() {
