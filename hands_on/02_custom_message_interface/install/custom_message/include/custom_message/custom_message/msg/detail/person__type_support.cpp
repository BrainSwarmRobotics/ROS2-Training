...
{
  new (message_memory) custom_message::msg::Person(_init);
}

void Person_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_message::msg::Person *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Person_message_member_array[2] = {
  {
    ...
    offsetof(custom_message::msg::Person, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_message::msg::Person, age),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Person_message_members = {
  ...
  "Person",  // message name
  2,  // number of fields
  sizeof(custom_message::msg::Person),
...
get_message_type_support_handle<custom_message::msg::Person>()
{
  return &::custom_message::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_message, msg, Person)() {
  return &::custom_message::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
