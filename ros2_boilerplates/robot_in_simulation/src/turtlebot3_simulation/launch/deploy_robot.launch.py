...
def generate_launch_description():
    ...
    package_name_gazebo = 'turtlebot3_simulation'
    pkg_share_gazebo = FindPackageShare(package=package_name_gazebo).find(package_name_gazebo)
    default_robot_name = 'VBot_v1'
    pkg_name = FindPackageShare(package="turtlebot3_simulation").find("turtlebot3_simulation")
    ...
    bras_robot_description_path = FindPackageShare("turtlebot3_simulation").find("turtlebot3_simulation")

    # Define the models directory inside the package
    models_path = os.path.join(bras_robot_description_path, "models")
    workspace_src_path = os.path.abspath(os.path.join(bras_robot_description_path, "../../../turtlebot3_simulation/share"))
