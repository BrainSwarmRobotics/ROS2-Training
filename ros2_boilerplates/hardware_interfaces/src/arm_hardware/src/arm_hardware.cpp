...
hardware_interface::CallbackReturn ArmHardware::on_init(const hardware_interface::HardwareInfo &info)
{
    ...
    node_ = rclcpp::Node::make_shared("arm_hardware");
    ...
    joint_states_subscriber_ = node_->create_subscription<sensor_msgs::msg::JointState>(
      "/joint_states", 10,
      std::bind(&ArmHardware::joint_states_callback, this, std::placeholders::_1));
...
void ArmHardware::joint_states_callback(const sensor_msgs::msg::JointState::SharedPtr msg)
{
...
void ArmHardware::send_command_to_motor(size_t joint_index, double position)
{
    auto msg = std_msgs::msg::Float64MultiArray();
...
PLUGINLIB_EXPORT_CLASS(arm_hardware::ArmHardware, hardware_interface::SystemInterface)
