...
def generate_launch_description():
    ...
    package_name_gazebo = 'simulation_worlds'
    pkg_share_gazebo = FindPackageShare(package=package_name_gazebo).find(package_name_gazebo)
    default_robot_name = 'VBot_v1'
    pkg_name = FindPackageShare(package="simulation_worlds").find("simulation_worlds")
    ...
    bras_robot_description_path = FindPackageShare("simulation_worlds").find("simulation_worlds")

    # Define the models directory inside the package
    models_path = os.path.join(bras_robot_description_path, "models")
    workspace_src_path = os.path.abspath(os.path.join(bras_robot_description_path, "../../../simulation_worlds/share"))
    ...
    world_file = os.path.join(
        get_package_share_directory('simulation_worlds'),
        'worlds',
